...
<link href="{{ asset('distinctive/css/screen.css') }}" rel="stylesheet" type="text/css" href="css/screen.css" media="screen" />
</head>
<body>
<div id="content">
  ...
  <div class="line"></div>
  <div id="pitch">
    <h1>We provide turnkey, high-quality<br />
      solutions regardless of the project size.</h1>
  ...
  <div id="footer">
    <p>&copy; Copyright 2009 Distinctive &minus; Design: Luka Cvrk, <a href="http://www.solucija.com">Solucija</a></p>
  </div>
</div>
</body>
</html>
